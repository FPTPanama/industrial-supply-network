...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const transactions = new Typed( TRANSACTIONS.current, {
      strings: ['TRANS^100ACTIONS^100 IN MORE^100'],
      typeSpeed: 30,
      loop: false,
      showCursor: false,
    });
  ...
  const [
    ...
    containerOnBoard, // Este es el boolean que te dice si esta o no.
  ] = useInView({
    // Detecta si el componente está en el viewport
    triggerOnce: false, // Esto hace que la detección solo ocurra una vez cuando el elemento entra en el viewport
    threshold: 0.2, // Define el umbral de visibilidad (0.5 significa que al menos la mitad del elemento debe estar en el viewport)
        ...
        <div className={classNames('flex', 'flex-col', 'md:gap-8', 'md:gap-5', 'gap-12')}>
          ...
          <section className={classNames('homTitWra')}>
            ...
            <div className={classNames('homTitBox')}>
              ...
              <div className={classNames('titBox', 'fade-on')}>
                ...
                <h2>for non-ferrous and ferrous products</h2>
              ...
              <div ref={containerRef} className={classNames('imgBox', 'slide-left')}>
                <Image src={'/img/container_blanco.webp'} width={580} height={760} alt="container" className={classNames('z-0')}/>
              </div>
            </div>
          </section>

          <section className={classNames('ourProWraBox')}>
            <h3 className={classNames('bolder', 'azuOscHrk', 'md:text-6xl', 'text-4xl', 'sm:leading-9')}>OUR PRODUCTS</h3>
            <div className={classNames('infBox')}>
              <div className={classNames('titBox')}>
                <p className={classNames('sm:text-2xl', 'text-xl', 'bolder')}>
                  We supply a great variety of finished and semi-finished products.
                </p>
                <p className={classNames('sm:text-xl', 'text-sm')}>Steel products, ferrous scrap, raw material, refined metals, concentrates and ores and related by-products. </p>
              </div>
              <div className={classNames('flex', 'items-center', 'justify-start', 'w-full')}>
                <p className={classNames('bolder', 'text-4xl')}>Products for industry</p>
              </div>
                      ...
                      >
                        ...
                        <div className={classNames('boxScr')}>
                          ...
                          <div  
                            ...
                            className={classNames('iteBoxBac', 'transition-all')} />
              ...
              <div className={classNames('flex', 'items-center', 'justify-start', 'w-full', 'mt-20')}>
                <p className={classNames('bolder', 'text-4xl')}>Products for construction</p>
              </div>
              <div className={classNames('imgWraBox')}>
                {
          ...
          <section className={classNames('whyHrkBox')}>
            ...
            <div className="infBox">
                ...
                <div ref={cargoRef} className={classNames('conImg', cargoOnBoard ? 'slide-left' : 'hidden')}>
               
                    <Image src={'/img/cargo_perforado_v2.webp'} width={699} height={330} alt={'operador'} className={classNames('z-0')}/>
            ...
            <div className="titBox">
              ...
              <h2 className={classNames('strong m0')}>MAXIMIZE COST EFFECTIVENESS.</h2>
              <h2 className={classNames('strong m0')}>MINIMIZE RISKS.</h2>

              <p className={classNames('reg')}>
                No matter what the cargo or destination,
                We can advise you in all the steps of the
                process, both <span className={classNames('strong')}>for ferrous and non-ferrous products
                ferrous</span>
              </p>

              <p className={classNames('reg')}>
                Our idea is to work with your company with
                solutions adapted to the needs of the
                project
              </p>
          ...
          <section className={classNames('anyWraBox')}>
            ...
            <div className={classNames('flex', 'flex-col', 'justify-center', 'md:items-start', 'items-center')}>

              <Image src={'/img/ten_years_blue.svg'} alt="10_anyos" height={40} width={250} className="w-4"/>

              <p className={classNames('strong', 'text-2xl', 'azuOscHrk', 'max-w-[300px]')}>TRADING IN OUR REGION</p>

            </div>

            <div className={classNames('splBox')}/>

            <div ref={parrafoRef} className={classNames('flex', 'flex-col', 'md:items-start', 'items-center', parrafoOnBoard ? 'slide-left' : 'hidden')}>

              <p ref={TRANSACTIONS} style={{fontFamily: 'popLig'}} className={classNames('azuOscHrk', 'md:text-5xl','text-2xl' , 'max-w-[300px]', 'md:text-left', 'text-center')} />
              <div className={classNames('flex', 'items-center', 'justify-start', 'gap-4')}> 
                <p ref={THAN} style={{fontFamily: 'popLig'}} className={classNames('azuOscHrk', 'md:text-5xl','text-2xl' , 'max-w-[300px]', 'md:text-left', 'text-center')}/>
                <span ref={TWENTY} style={{fontFamily: 'popBold'}} className={classNames('azuOscHrk', 'md:text-5xl','text-2xl' , 'max-w-[300px]', 'md:text-left', 'text-center')}/>
              </div>
              <p ref={COUNTRIES} style={{fontFamily: 'popLig'}} className={classNames('azuOscHrk', 'md:text-5xl','text-2xl' , 'max-w-[300px]', 'md:text-left', 'text-center')}/>
            </div>
          ...
          <section className={classNames('whaCanWeDo')}>
            ...
            <h3 className={classNames('bolder', 'azuOscHrk', 'md:text-6xl', 'text-4xl', 'sm:leading-9')}>WHAT CAN WE DO?</h3>
          ...
          <section className={classNames('numStats', 'hidden')}>

              {
                numStasts.map((item, key) => {
                  return (
                    <div ref={item.ref} key={key} className={classNames('iteNumBox', item.show ? 'slide-bottom': 'hidden')}>
                      <Counter startCount={item.show} className={classNames('titTex','text-9xl', 'font-bold', 'azuOscHrk')} value={item.amount}/>
                      {/* <p className={classNames('titTex','text-9xl', 'font-bold', 'azuOscHrk')}>{item.amount > 9000 ? <>{item.amount / 1000}<span className="font-light text-5xl">K</span></>: item.amount }</p> */}
                      <p className={classNames('text-2xl', 'azuOscHrk')}>{item.title}</p>
                    </div>
                  )
                })
              }
